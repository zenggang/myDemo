...
- (void)setSeparatorHeight:(CGFloat) separatorHeight forColor:(UIColor *) color
{
    [(FUICellBackgroundView*)self.selectedBackgroundView setSeparatorColor:color];
    [self setSeparatorHeight:separatorHeight];
