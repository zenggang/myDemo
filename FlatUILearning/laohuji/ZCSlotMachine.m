...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _backgroundImageView.contentMode = UIViewContentModeRedraw;
...
- (void)reloadData {
    if (self.dataSource) {
        ...
        for (int i = 0; i < numberOfSlots; i++) {
            ...
            slotContainerLayer.frame = CGRectMake(i * (slotWidth + slotSpacing)+10, 0, slotWidth, _contentView.frame.size.height);
        ...
        for (int i = 0; i < numberOfSlots; i++) {
            ...
            for (int j = 0; j > scrollLayerTopIndex; j--) {
                ...
                iconImageLayer.contentsScale = _iconContentScale;
