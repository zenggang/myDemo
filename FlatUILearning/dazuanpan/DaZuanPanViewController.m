//
//  DaZuanPanViewController.m
//  FlatUILearning
//
//  Created by gang zeng on 14-4-28.
...
@interface DaZuanPanViewController ()
...
@property (nonatomic,strong) ZuanPanView *zuanPanView;
...
@implementation DaZuanPanViewController{
@private
...
- (void)dealloc {
    ...
    [_zuanPanView stopLightingAnimation];
    _zuanPanView=nil;
    _dropCoinView=nil;
...
- (void)viewDidLoad {
    ...
    if (IS_IPHONE5) {
        ...
        _zuanPanView.center=CGPointMake(160, 158);
        ...
        _backGroudImageView.image=[UIImage imageNamed:@"dazuanpan_iphone4_bg" ];
    }
...
- (void)start {
    ...
    [Dazuanpan buyDazuanpanWithData:[AppUtilities goldDataEncryptWithPid:1 andGoldAmount:_coinAmount*oneCoinWorth] OnSuccess:^(id respons) { 
        ...
        [_zuanPanView startRollingToNumber:number];
        NSLog(@"%@",respons);
...
#pragma mark - zuanpanViewDelegate
