...
#define WAPS_VIEW_CLOSED                          @"WAPS_VIEW_CLOSED"

#define WAPS_POPAD_CLOSED                          @"WAPS_POPAD_CLOSED"
#define WAPS_POPAD_CONTROLLER_CLOSED               @"WAPS_POPAD_CONTOLLER_CLOSED"
#define WAPS_POPAD_SHOW                          @"WAPS_POPAD_SHOW"

#define WAPS_AD_SHOW_SUCESS                      @"WAPS_AD_SHOW_SUCESS"
#define WAPS_AD_SHOW_FAILED                      @"WAPS_AD_SHOW_FAILED"
...
#define WAPS_POPAD_SHOW_SUCESS                        @"WAPS_POPAD_SUCESS"
#define WAPS_POPAD_SHOW_FAILED                        @"WAPS_POPAD_FAILED"

#define WAPS_POPAD_CLICKED                    @"WAPS_POPAD_CLICKED"

#define WAPS_AD_SHOW                            @"WAPS_AD_SHOW"
#define WAPS_AD_CLICK                            @"WAPS_AD_CLICK"
